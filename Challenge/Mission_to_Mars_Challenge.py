 ...
 "cells": [
   ...
   "outputs": [
    {
     ...
     "text": [
      ...
      "[WDM] - Driver [C:\\Users\\jsjer\\.wdm\\drivers\\chromedriver\\win32\\95.0.4638.69\\chromedriver.exe] found in cache\n"
     ]
    }
   ],
   "source": [
  ...
  },
  {
   ...
   "source": [
    ...
    "    print(browser.find_by_tag(\"h3\")[i].text)"
   ]
  },
  {
   "cell_type": "code",
   ...
   "source": [
    ...
    "    a = browser.find_by_css(\".description\")[i].links\n",
    "#     a.click()\n",
    "#     print(a.find_by_text(\"Sample\")[\"href\"])\n",
    "    print(a.find_by_href(\"cerberus.html\")[\"href\"])\n",
    "    "
   ]
  },
  {
   ...
   "outputs": [],
   "source": [
    "image_url = [\"cerberus.html\", \"schiaparelli.html\", \"syrtis.html\", \"valles.html\"]\n"
   ]
  },
  {
   "cell_type": "code",
   ...
   "source": [
    "len(browser.find_by_css(\".description\"))"
   ]
  },
  {
   "cell_type": "code",
   ...
   "outputs": [],
   "source": [
    "test = browser.find_by_css(\".description\")[0].find_by_tag(\"a\")"
   ]
  },
  {
   "cell_type": "code",
